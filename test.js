...
console.log('loding',process.argv[2],process.argv[3],process.argv[4],process.argv[5],process.argv[6]);


geo.load(process.argv[2],process.argv[3],process.argv[4],process.argv[5],process.argv[6]);
